...
| [!UICONTROL Ship Method]          | The [!DNL Walmart Marketplace] Shipping Method selected for the order. For details about the possible values, see [Shipping Methods and Timing Policy](https://sellerhelp.walmart.com/s/guide?article=000007893) in the [!DNL Walmart Marketplace Seller Help].                                                                                                           |
