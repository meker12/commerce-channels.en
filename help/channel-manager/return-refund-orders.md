...
<tr>
<td>[!UICONTROL RMA #]</td>
<td>The Return Request Authorization number received from [!DNL Walmart Marketplace]. The number is generated by Walmart during the marketplace return processing.</td>
</tr>
<tr>
...
<td>Indicates the current RMA status in the [!DNL Commerce] return workflow–<i>Received</i>, <i>Refunded</i>, or <i>Error</i>.</td>
</tr>
<tr>
...
Return status updates occur when [!DNL Channel Manager] receives an RMA request from the [!DNL Walmart Marketplace] or when the [!DNL Commerce] credit memo is created to process the refund for the returned items.
...
1. From the Returns table, find an RMA with the *[!UICONTROL Received]* status.
