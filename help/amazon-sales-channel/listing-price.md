...
1. For **Currency Conversion**, choose an option.
   ...
   The default is `Disabled`. These options depend on your [!DNL Commerce] [currency](https://docs.magento.com/user-guide/configuration/general/currency-setup.html){target="_blank"} settings. If no options are available, you may need to set up your currency settings.
