...
[!DNL Amazon Sales Channel] allows you to access, review, create, and manage attributes, as needed, in the [_Attributes_ view](./attributes-view.md) on the [!DNL Amazon Sales Channel] home page. If you add an attribute to your [!DNL Commerce] catalog, it could require an update of those values across all products.
